...
\usepackage{amsmath, amsthm, amsfonts, enumitem, graphicx, subcaption, cleveref, tabularx, xpatch, imakeidx, setspace, mathptmx, titlesec, fancyhdr, etoolbox, tocloft, lipsum, amssymb, algorithm, algpseudocode}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \vtop{
        	...
        	\caption{A poor Latin Hypercube sampling in 2 dimension. Despite it stratifies completely the square, it busts the experiment.\\ The diagonal sampling depicts how insufficient a pure LHS is to achieve a good simulation.}
...
\begin{figure}[H]
    ...
    \vtop{
        \vspace{0pt}
       	\includegraphics[width=0.8\textwidth]{../data/plots/exp2.mcaccuracy.N_100_to_10000.v2.png}
    }
    \captionsetup{skip=0pt}
    \midcaption{}
...
\begin{figure}[H]
    ...
    \vtop{
        \vspace{0pt}
       	\includegraphics[width=0.8\textwidth]{../data/plots/exp2.mctime.N_100_to_10000.v2.png}
    }
    \captionsetup{skip=0pt}
