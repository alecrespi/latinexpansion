...
\usepackage{amsmath, amsthm, amsfonts, enumitem, graphicx, subcaption, cleveref, tabularx, xpatch}
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{The images were kindly taken from \fancycite{Sheikholeslami2017}.}
